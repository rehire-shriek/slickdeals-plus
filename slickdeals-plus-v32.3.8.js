...
(function () {
    ...
    function ProcessingModule(context) {
        ...
        function processDealCard(card) {
            ...
            try {
                ...
                const votes = UtilsModule.parseHumanNumber(el.voteEl?.textContent);
    ...
    (async function init() {
        await safeExecute(async () => {
            ...
            try {
                const existingFeed = document.querySelector(ConstantsModule.SELECTORS.dealFeed);
                if (existingFeed) {
                    attachFeedObserver(existingFeed);
                } else {
